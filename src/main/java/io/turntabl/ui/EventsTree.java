...
public class EventsTree {
    ...
    private String[] eventNodes = {"JVM Information", "Java Monitor Wait", "JFR Method Sample",  "JFR Compilation"};
    ...
    public EventsTree(NewRelicJavaProfilerToolWindow newRelicJavaProfilerToolWindow) {
        ...
        JBPanel[] eventsPanel = {jvmInfoEventPanel.getJVMInfoEventComponent(), javaMonitorWaitPanel.getJavaMonitorWaitComponent(), jfrCompilationPanel.getJfrCompilationComponent(), jfrMethodSamplePanel.getJfrMethodSampleComponent()};//add other panels here...........
