...
public class MetricsTree {
    ...
    public MetricsTree(NewRelicJavaProfilerToolWindow newRelicJavaProfilerToolWindow) {
        ...
        String[] jvmNodes = {"Garbage Collection", "GC Heap Summary"};
        ...
        JBPanel[] jvmComponents = {garbageCollectionPanel.getGarbageCollectionComponent(), gcHeapSummaryPanel.getGcHeapSummaryComponent()};
